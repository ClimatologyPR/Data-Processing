# -*- coding: utf-8 -*-
# https://superuser.com/questions/1303531/open-dly-file-ghcn-noaa-data-for-analysis
"""
File: read_ghcn.py
Author: ned haughton
...
def read_station_metadata(filename="C:/Users/Roberto/Desktop/ghcnd-stations.txt"):
...
def read_ghcn_data_file(filename="C:/Users/Roberto/Desktop/RQC00660053.dly",
...
#print(read_station_metadata())

df = read_ghcn_data_file()

df.to_csv(path_or_buf="C:/Users/Roberto/Desktop/rqc.csv")
